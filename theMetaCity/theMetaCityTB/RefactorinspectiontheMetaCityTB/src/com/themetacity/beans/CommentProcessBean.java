 ...
 */
class CommentProcessBean {

    private final LinkedList<CommentBean> listOfBeans = new LinkedList<CommentBean>();    // The list containing commentBeans
    ...
    public LinkedList getComments() {
        ...
        try {
            ResultSet result= dbBean.executeQuery("SELECT * FROM comments" + " " +

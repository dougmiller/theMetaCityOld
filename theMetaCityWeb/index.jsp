...
<jsp:useBean id="ImportantNoticeBean" scope="page" class="com.themetacityweb.beans.ImportantNoticeProcessBean"/>

<jsp:useBean id="ArticleProcessBean" scope="page" class="com.themetacityweb.beans.ArticleProcessBean">
